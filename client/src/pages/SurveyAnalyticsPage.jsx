 ...
 <div style={{ display: "flex", justifyContent: "space-between", gap: 12, flexWrap: "wrap", alignItems: "center" }}>
        ...
        {(d.questions || []).map((q) => (
          <div className="card" key={q.questionId}>
            <div style={{ display: "flex", justifyContent: "space-between", gap: 12 }}>
              <div style={{ fontWeight: 800 }}>{q.order}. {q.prompt}</div>
  ...
  <div style={{ marginTop: 12 }}>
    ...
    <div style={{ marginTop: 10 }}>
      <BarList
        items={[
          { label: "5★", value: Number(q.ratingDist?.[5] || 0) },
          { label: "4★", value: Number(q.ratingDist?.[4] || 0) },
          { label: "3★", value: Number(q.ratingDist?.[3] || 0) },
          { label: "2★", value: Number(q.ratingDist?.[2] || 0) },
          { label: "1★", value: Number(q.ratingDist?.[1] || 0) },
        ]}
        labelKey="label"
        valueKey="value"
      />
